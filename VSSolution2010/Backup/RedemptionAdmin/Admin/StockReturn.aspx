<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="StockReturn.aspx.cs" Inherits="RedemptionAdmin.Admin.StockReturn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <asp:Button ID="ShowCreateStockReceiveBut" runat="server" Text="New return stock"
        ...
        <asp:Panel ID="ClientDetailPnl" runat="server">
            ...
            <div class="row">
                ...
                <div class="right box">
                    <asp:Button ID="CreateStockReceiveBut" runat="server" Text="Create stock return"
        ...
        <telerik:RadGrid ID="RadGrid1" runat="server" OnItemCommand="RadGrid1_ItemCommand" EnableLinqExpressions="false"
            ...
            <MasterTableView AutoGenerateColumns="false" CommandItemDisplay="TopAndBottom" DataKeyNames="stockreturnid">
                ...
                <Columns>
                    <telerik:GridBoundColumn HeaderText="Stock Return ID" DataField="stockreturnid" />
