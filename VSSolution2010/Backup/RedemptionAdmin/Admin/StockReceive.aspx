<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="StockReceive.aspx.cs" Inherits="RedemptionAdmin.Admin.StockReceive" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <asp:Button ID="ShowCreateStockReceiveBut" runat="server" Text="New Receiving Note"
        ...
        <asp:Panel ID="ClientDetailPnl" runat="server">
            ...
            <div class="row">
                ...
                <div class="right box">
                    ...
                    <asp:RequiredFieldValidator ControlToValidate="CompanyTB" ID="RequiredFieldValidator3"
                        runat="server" ErrorMessage="Please enter the company." CssClass="failureNotification"
            ...
            <div class="row">
                ...
                <div class="right box">
                    ...
                    </telerik:RadNumericTextBox><asp:RequiredFieldValidator ControlToValidate="QtyTB" ID="RequiredFieldValidator1"
                        runat="server" ErrorMessage="Please enter the in qty." CssClass="failureNotification"
                        ValidationGroup="form" Display="Dynamic"></asp:RequiredFieldValidator><asp:RegularExpressionValidator
            ...
            <div class="row">
                ...
                <div class="right box">
                    <asp:Button ID="CreateStockReceiveBut" runat="server" Text="Create StockReceive"
        ...
        <telerik:RadGrid ID="RadGrid1" runat="server" OnItemCommand="RadGrid1_ItemCommand"
            EnableLinqExpressions="false" AllowPaging="True" AllowSorting="True" AllowFilteringByColumn="True"
            OnNeedDataSource="RadGrid1_NeedDataSource1" ExportSettings-FileName="RewardLists"
            ExportSettings-IgnorePaging="true" CellSpacing="0" GridLines="None" OnItemDataBound="RadGrid1_ItemDataBound">
            ...
            <MasterTableView AutoGenerateColumns="false" CommandItemDisplay="TopAndBottom" DataKeyNames="stockreceiveid">
                ...
                <Columns>
                    <telerik:GridBoundColumn HeaderText="Stock Receive ID" DataField="stockreceiveid" />
