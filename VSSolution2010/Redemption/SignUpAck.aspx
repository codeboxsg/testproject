    ...
    <div id="main" role="main">
        <div class="container">
            ...
            <div id="NewDiv" runat="server" class="sixteen columns">
                <p>
                    Registration is successful.You will receive an email confirmation shortly.<br/>
					Please be informed that the email may end up in your spam folder. Do keep a lookout.<br/>
					If you do not receive any email from us within the next three hours, do drop us a note at <a href="mailto:feedback@mceduperks.com">feedback@mceduperks.com</a></p>
            </div>
        </div>
        <!-- container -->
    </div>
