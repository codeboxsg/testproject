...
{
    public partial class ReportMember : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            String filename = "MemberReport_" + ClientDDL.SelectedItem.Text +"_"+ DateTime.Today.ToString("dd/MM/yyyy")+ ".xls";
            ...
            Response.Write(WriteMember(vw, clientid));
        ...
        private static string WriteMember(System.IO.StreamWriter vw, int clientid)
        {
            StringWriter stringWriter = new StringWriter();
            HtmlTextWriter htmlWrite = new HtmlTextWriter(stringWriter);


            var x = ClientManager.getAllRedemptionMembersByClient(clientid);
           // var x = ClientManager.getStockSummary();
